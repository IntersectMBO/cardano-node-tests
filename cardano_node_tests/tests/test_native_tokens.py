...
class TestMinting:
    ...
    def test_minting_multiple_scripts(
        ...
        * (optional) check transactions in db-sync
        ...
        expected_fee = MINT_MULTIPLE_FEE[1] if build_method == clusterlib_utils.BuildMethods.BUILD else MINT_MULTIPLE_FEE[0]
        num_of_scripts = 5
    ...
    def test_bundle_minting_and_burning_witnesses(
        ...
        * (optional) check transactions in db-sync
        ...
        expected_fee = expected_fee_build if build_method == clusterlib_utils.BuildMethods.BUILD else expected_fee_raw
