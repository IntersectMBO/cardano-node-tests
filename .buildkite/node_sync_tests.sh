...
hydra_eval_no2=$4
desired_env=$5
node_start_arguments=$6

echo " ==== start sync test"
python ./sync_tests/node_sync_test.py -t1 "$tag_no1" -t2 "$tag_no2" -e "$desired_env" -e1 "$hydra_eval_no1" -e2 "$hydra_eval_no2" -a "$node_start_arguments"
