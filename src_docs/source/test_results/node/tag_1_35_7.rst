...
.. list-table:: other testing
   ...
   * - upgrade job (1.35.6 to 1.35.7-rc2)
     - |:heavy_check_mark:|
...
.. list-table::
   ...
   * - `1.35.7-rc2` pushed to `shelley-qa`
     - |:hourglass_flowing_sand:|
   * - Grafana metrics OK
     - |:hourglass_flowing_sand:|
   * - Regression testing against `shelley-qa` - `results <https://cardano-tests-reports-3-74-115-22.nip.io/shelley_qa/1.35.7-rc2/>`__
     - |:hourglass_flowing_sand:|
...
\* RAM usage for `1.35.7-rc2` is between 2 to 3 GB higher than for `1.35.5`.
