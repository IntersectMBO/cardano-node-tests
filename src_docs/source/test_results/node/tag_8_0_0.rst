...
* `[BUG] - Unclear '--signed-tx-file' argument to 'governance verify-poll' <https://github.com/input-output-hk/cardano-node/issues/5183>`__  (fixed in final 8.0.0)
...
* `[FR] - Allow usage of delegate keys for '--required-signers' <https://github.com/input-output-hk/cardano-node/issues/5203>`__  (fixed in final 8.0.0)
